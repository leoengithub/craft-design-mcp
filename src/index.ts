  ...
  messages: [{
    ...
    content: {
      ...
      text: [
        ...
        "- Before start_craft, inspect the codebase for a known design library when possible (package.json, imports, component usage). If you detect one, pass project_design_system to start_craft.",
        "",
        ...
        "- NEVER stop the workflow after asking questions — always proceed to the next continue_craft call once answers are in.",
        "",
        "## Workflow steps",
        ...
        "5. If DESIGN.md exists and the user's request is still about the same design goal: call start_craft({ goal: 'resume', design_md: <contents>, components_md?: <contents>, craft_components_json?: <contents>, craft_ds_md?: <contents>, project_design_system?: <name>, renderer?: 'code'|'figma', figma_session_id?: <id> }).",
        ...
        "6. If DESIGN.md does not exist: ask the user what they want to design, then call start_craft({ goal: <answer>, components_md?: <contents>, craft_components_json?: <contents>, craft_ds_md?: <contents>, project_design_system?: <name>, renderer?: 'code'|'figma', figma_session_id?: <id> }).",
