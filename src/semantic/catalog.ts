...
const CATALOG: SemanticComponentSpec[] = [
  ...
  },
  {
    ...
    required_tokens: ["surface", "border", "text", "muted"],
    composition_rules: [
      "Forms in dialogs use a clear title, compact body rhythm, and a distinct actions row.",
      "Avoid decorative full-bleed backgrounds when the task is an application dialog or focused form.",
    ],
    fallback_kind: "stack",
  },
  {
  ...
  },
  {
    id: "field.select",
    category: "field",
    slots: ["label", "value", "help"],
    variants: [{ id: "default" }, { id: "outlined" }],
    states: ["empty", "filled", "error"],
    required_tokens: ["surface", "border", "text", "muted"],
    composition_rules: [
      "Select controls should visibly indicate they open a menu.",
      "The current value should remain visually distinct from helper text.",
    ],
    fallback_kind: "stack",
  },
  {
    id: "toggle.switch",
    category: "toggle",
    slots: ["label", "description", "control"],
    variants: [{ id: "default" }],
    states: ["on", "off", "disabled"],
    required_tokens: ["surface", "border", "primary", "muted"],
    composition_rules: [
      "Switches are binary controls paired with visible labels.",
      "The control should read as secondary to the label copy, not as decorative chrome.",
    ],
    fallback_kind: "stack",
  },
  {
    ...
    variants: [{ id: "default" }],
    states: ["default"],
    required_tokens: ["surface", "border", "text", "primary"],
    composition_rules: [
      "Actions rows align dismissive controls before the primary action.",
      "The primary action should remain singular and visually strongest.",
    ],
    fallback_kind: "stack",
  },
  {
